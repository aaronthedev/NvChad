return {
  ...
  },
  {
    ...
    config = function()
      ...
      require("custom.configs.lspconfig")  -- your clangd setup
    end,
  },
  {
  ...
  },
  {
    ...
    build = function()
      ...
      require("unrealengine.commands").build_engine({ engine_path = "/mnt/e/MYUE/TremEng" })
    end,
    opts = {
      ...
      engine_path = "/mnt/e/MYUE/TremEng", -- Path to your UnrealEngine source directory
